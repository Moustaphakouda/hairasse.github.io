...
export default function About() {
  return (
    <section id="apropos" className="py-24 lg:py-32 bg-cream-100 relative overflow-hidden">
      <div className="absolute top-20 right-0 w-72 h-72 bg-gold-100/40 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative opacity-0-init animate-fade-up">
            ...
            {/* Floating quote card */}
            <div className="absolute -bottom-6 -right-4 lg:-right-8 max-w-xs bg-cream-50 rounded-2xl shadow-gold-lg p-6">
              ...
              <p className="text-gold-600 text-sm font-medium mt-3">
                — Élodie, Fondatrice
              </p>
            </div>

            {/* Decorative element */}
            <div className="absolute -top-6 -left-6 w-24 h-24 border-2 border-gold-200 rounded-2xl -z-10" />
          </div>
          ...
          <div className="flex flex-col gap-6 opacity-0-init animate-fade-up delay-200">
            ...
            <div className="grid grid-cols-2 gap-4 mt-4">
              {stats.map((stat) => (
                <div
                  key={stat.label}
                  className="bg-cream-50 rounded-2xl p-5 border border-gold-100 hover-lift hover:shadow-gold"
                >
