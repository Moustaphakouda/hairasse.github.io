...
export default function Contact() {
  ...
  return (
    ...
    >
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-gold-100/30 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="grid lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2 flex flex-col gap-5 opacity-0-init animate-fade-up">
            <div className="bg-cream-50 rounded-3xl p-8 border border-gold-100 shadow-gold">
              ...
              <div className="flex flex-col gap-5">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-sm text-stone-400 mb-1">Adresse</p>
                    <p className="text-stone-700 font-medium">{salonInfo.address}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-sm text-stone-400 mb-1">Téléphone</p>
                    <a
                      href={`tel:${salonInfo.phone.replace(/\s/g, '')}`}
                      className="text-stone-700 font-medium hover:text-gold-600 transition-colors"
                    >
                      {salonInfo.phone}
                    </a>
                  </div>
          ...
          <div className="lg:col-span-3 opacity-0-init animate-fade-up delay-200">
            <form
              ...
              className="bg-cream-50 rounded-3xl p-8 lg:p-10 border border-gold-100 shadow-gold"
            >
              {submitted ? (
                <div className="flex flex-col items-center justify-center text-center py-16 animate-scale-in">
                  <div className="w-20 h-20 rounded-full bg-gold-100 flex items-center justify-center mb-5">
                ...
                <>
                  ...
                  <div className="grid sm:grid-cols-2 gap-5">
                    <div>
                      <label className="block text-sm text-stone-500 mb-2 font-medium">
                        Nom complet *
                      </label>
                      <input
                        type="text"
                        ...
                        className="w-full px-4 py-3 rounded-xl bg-cream-100 border border-gold-100 focus:border-gold-400 focus:outline-none focus:ring-2 focus:ring-gold-200 transition-all text-stone-700"
                  ...
                  <div className="mt-5">
                    ...
                    <textarea
                      ...
                      value={form.message}
                      onChange={handleChange}
                      className="w-full px-4 py-3 rounded-xl bg-cream-100 border border-gold-100 focus:border-gold-400 focus:outline-none focus:ring-2 focus:ring-gold-200 transition-all text-stone-700 resize-none"
